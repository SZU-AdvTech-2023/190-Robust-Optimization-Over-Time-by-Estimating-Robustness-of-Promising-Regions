...
function Problem = BenchmarkGenerator_GMPB(PeakNumber,ChangeFrequency,Dimension,ShiftSeverity,EnvironmentNumber,BenchmarkName)
     ...
     Problem.MaxEta              = 20;
     Problem.MinEta              = -20;
     Problem.QualityThreshold    = 40;%ROOT
     Problem.ComputationalBudget = floor(ChangeFrequency/2);%ROOT
     Problem.DeadLine            = 0;%ROOT
     Problem.AverageSurvivalTime = 0;%ROOT
     Problem.HeightSeverity      = 1+rand()*14;%ROOT
     Problem.AngleSeverity       = pi/9;
     Problem.TauSeverity         = 0.05;%ROOT
     Problem.EtaSeverity         = 2;
     Problem.WidthSeverity       = 0.1+rand()*1.4;%ROOT
