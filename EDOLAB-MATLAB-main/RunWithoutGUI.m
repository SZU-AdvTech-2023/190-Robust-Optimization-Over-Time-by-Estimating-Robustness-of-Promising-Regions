...
AlgorithmName = 'mPSO_RE_CRA';    %Please input the name of algorithm (EADO) you want to run here (names are case sensitive).
...
ShiftSeverity                  = 1+rand()*4;           %The default value is 1 
EnvironmentNumber              = 100;                  %The default value is 100
RunNumber                      = 30;                   %It should be set to 31 in Experimentation module, and must be set to 2 for using Education module.
%% ********Figures and Outputs********
...
[Problem,E_bbc,E_o,E_ast,CurrentError,VisualizationInfo,Iteration] = main_EDO(VisualizationOverOptimization,PeakNumber,ChangeFrequency,Dimension,ShiftSeverity,EnvironmentNumber,RunNumber,BenchmarkName);
%% Output
close;clc;
...
disp(['Average survival time ==> ', ' Mean = ', num2str(E_ast.mean), ', Median = ', num2str(E_ast.median), ', Standard Error = ', num2str(E_ast.StdErr)]);
